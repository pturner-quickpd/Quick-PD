...
const ROUTE_LABELS = {
  ...
  "science": "Early Science (K–5)",
  "early-social-studies": "Early Social Studies (K–5)",
  "social-studies": "Early Social Studies (K–5)",
  ...
  "secondary-science": "Secondary Science (6–12)",
  "secondary-social": "Secondary Social Studies (6–12)",
...
const Routes = {
  ...
  // /science and /social-studies alias to the live K–5 domain pages already built in elementary.js
  "science": renderModulePage("Elementary","renderScience"),
  "social-studies": renderModulePage("Elementary","renderSocialStudies"),
  ...
  "secondary-science": (view) => window.ContentHubs.renderSecondaryScience(view, Data.strategies),
  "secondary-social": (view) => window.ContentHubs.renderSecondarySocial(view, Data.strategies),
